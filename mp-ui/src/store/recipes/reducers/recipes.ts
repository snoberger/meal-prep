...
const recipes = (state = initialState, action: any) => {
    ...
    switch (action.type) {
        ...
        case DELETE_RECIPE:
            state.recipeList.splice(action.index, 1);
            return {
                ...state,
            };
        default:
